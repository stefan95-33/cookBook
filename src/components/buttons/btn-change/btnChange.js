        ...
        return (
            <>
                <ButtonToolbar onClick={handleShow}>
                    <Button className="btnInsideDescription" variant="outline-primary">Change</Button>
                </ButtonToolbar>
                ...
                <Modal show={show} onHide={handleClose}>
                    ...
                    <Modal.Body>
                        ...
                        <Form.Control value={recipes.title} onChange={handleChangeRecipes} type="text" name="title" placeholder="Title" />
                        <Form>
                            <Form.Group controlId="exampleForm.ControlTextarea1">
                                <Form.Label>Enter Ingredients:</Form.Label>
                                <Form.Control value={recipes.ingredients} name="ingredients" onChange={handleChangeRecipes} as="textarea" rows="3" />

                                <Form.Label>How To Cook</Form.Label>
                                <Form.Control value={recipes.howToCook} onChange={handleChangeRecipes} name="howToCook" as="textarea" rows="3" />
                            </Form.Group>
                        </Form>
...
const mapDispatchToProps = (dispatch) => {
    return{
        changeRecipe: (title, ingredients, howToCook, id) => changeRecipeOnServer({
            title,
            ingredients,
            howToCook
        }, id)(dispatch)
